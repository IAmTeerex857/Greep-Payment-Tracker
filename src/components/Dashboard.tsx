  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Overview of your payment tracking system</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              return (
                <div key={payment.id} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-b-0">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">{payment.week_start_date}</p>
                  </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900 mb-6">Pending Payouts</h3>
          <div className="space-y-4">
            {payouts.filter(p => p.status === 'pending').map((payout) => {
              ...
              return (
                <div key={payout.id} className="flex items-center justify-between py-3 border-b border-gray-100 last:border-b-0">
                  <div>
                    <p className="font-medium text-gray-900">{investor?.name || 'Unknown Investor'}</p>
                    <p className="text-sm text-gray-500 mt-1">{payout.month}</p>
                  </div>
