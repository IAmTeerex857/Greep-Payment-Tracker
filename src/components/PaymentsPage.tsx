        ...
        <div className="flex flex-col sm:flex-row sm:items-center  gap-4">
          <div className="relative" ref={datePickerRef}>
            <button
              ...
              className="w-full sm:w-auto px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm bg-white hover:bg-gray-50 transition-all duration-200 flex items-center justify-between min-w-[200px] group"
            >
            ...
            {showDatePicker && (
              <div className="absolute top-full left-0 sm:left-0 sm:right-auto mt-2 z-50 bg-white border border-gray-200 rounded-lg shadow-xl">
                <DateRange
                  ranges={dateRange}
                  onChange={(ranges) => {
                    setDateRange([
